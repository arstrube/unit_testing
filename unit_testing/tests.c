...
{
  IT("List is not NULL after creation");
...
{
  IT("List size is 1 after inserting an element");
  __list_t* l = __list_create(sizeof(int));
  int element = 25;
...
{
  IT("List is NULL after destruction");
  __list_t* l = __list_create(sizeof(int));
  __list_destroy(&l);
...
static void Test_ListElementIsInsertedBeforeAnother(void)
{
  int before = 7;
  int another = 8;
  IT("List element is inserted before another");
  __list_t* l = __list_create(sizeof(int));
...
static void Test_ListElementIsInsertedAfterAnother(void)
{
  int after = 9;
  int another = 8;
  IT("List element is inserted after another");
  __list_t* l = __list_create(sizeof(int));
  __list_insert(l, &another, 0);
...
static void Test_ListElementInsertedBeyondEndReturnsError(void)
{
  ...
  int second = 0;
  int test = 15;
  IT("List element inserted beyond the end of the list results in error");
  __list_t* l = __list_create(sizeof(int));
...
static void Test_ListIsEmptyAfterRemovingTheLastElement(void)
{
  int input_elem = 5;
  int output_elem = -1;
  IT("List is empty after removing the last element");
  __list_t* l = __list_create(sizeof(int));
...
{
  int element = 5;
  IT("List returns an error for inserting at index -1");
  __list_t* l = __list_create(sizeof(int));
...
{
  int element = 3;
  IT("List can get the first element");
  __list_t* l = __list_create(sizeof(int));
  __list_insert(l, &element, 0);
...
static void Test_ListCanGetSecondElement()
{
  int elements[] = {4, 3};
  int result;
  IT("List can get the second element");
  __list_t* l = __list_create(sizeof(int));
...
{
  int element = 5;
  IT("List returns an error for trying to get at -1");
  __list_t* l = __list_create(sizeof(int));
...
{
  int element = 5;
  IT("List returns an error for trying to get beyond end");
  __list_t* l = __list_create(sizeof(int));
  UCUNIT_CheckIsEqual(-1, __list_get(l, &element, 1));
  __list_destroy(&l);
  IT_END;
...
static void Test_ListCanRemoveSecondElement()
{
  int elements[] = {4, 3};
  int result;
  IT("List can remove the second element");
  __list_t* l = __list_create(sizeof(int));
  __list_insert(l, elements, 0);
  __list_insert(l, elements + 1, 1);
...
{
  int element = 5;
  IT("List returns an error for trying to remove at -1");
  __list_t* l = __list_create(sizeof(int));
...
{
  int element = 5;
  IT("List returns an error for trying to remove beyond end");
  __list_t* l = __list_create(sizeof(int));
  UCUNIT_CheckIsEqual(-1, __list_rem(l, &element, 1));
  __list_destroy(&l);
  IT_END;
